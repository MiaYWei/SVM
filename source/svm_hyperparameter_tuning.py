...
# Resample the imbalance dataset by using SMOTE + ENN
...
# define the search
search = BayesSearchCV(estimator=SVC(shrinking = False, cache_size = 10000, verbose = True, 
                       random_state = 42), search_spaces=params, n_jobs=-1, cv=cv, iid=False)
# perform the search
